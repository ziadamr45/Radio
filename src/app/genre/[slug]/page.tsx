...
function generateGenreSEOContent(genre: typeof GENRE_CONFIG[string], stationCount: number): string {
  ...
  const contentMap: Record<string, string> = {
    ...
    islamic: `
      ...
      <p>تشمل محطاتنا الإسلامية برامج في تفسير القرآن والحديث النبوي والفقه الإسلامي والسيرة النبوية. كما تقدم المحطات أناشيد إسلامية وأذكار وأدعية. مع أكثر من ${stationCount} محطة إذاعية إسلامية، ستجد محتوى يناسب جميع الأعمار والاهتمامات.</p>
