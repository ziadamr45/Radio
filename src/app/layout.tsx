...
export const metadata: Metadata = {
  ...
  description: "اسمع راديو - أكثر من 40,000 محطة راديو من جميع أنحاء العالم بث مباشر. محطات القرآن الكريم، الموسيقى، الأخبار، الرياضة، الدراما، القصص. مساعد ذكي للبحث والتوصيات. راديو من أكثر من 250 دولة.",
  keywords: [
